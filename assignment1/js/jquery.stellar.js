(function($, window, document, undefined) {
  ...
  Plugin.prototype = {
    ...
    _defineElements: function() {
      ...
      this.$viewportElement = this.options.viewportElement !== undefined
    ...
    _defineSetters: function() {
      ...
      this._setScrollLeft = typeof setScrollLeft === "function"
        ? function(val) {
            setScrollLeft(self.$scrollElement, val);
          }
        : $.noop;

      this._setScrollTop = typeof setScrollTop === "function"
        ? function(val) {
    ...
    _findParticles: function() {
      ...
      this.$element.find("[data-stellar-ratio]").each(function(i) {
        ...
        marginLeft = $this.css("margin-left") === "auto"
          ? 0
        ...
        verticalOffset = $this.data("stellar-vertical-offset") !== undefined
        ...
        self.particles.push({
          ...
          stellarRatio: $this.data("stellar-ratio") !== undefined
  ...
  $.fn[pluginName] = function(options) {
    ...
    if (options === undefined || typeof options === "object") {
      ...
      return this.each(function() {
        ...
        if (
          instance instanceof Plugin && typeof instance[options] === "function"
        ) {
